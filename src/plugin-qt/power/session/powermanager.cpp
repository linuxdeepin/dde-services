...
bool PowerManager::shouldPreventIdle() const
{
    ...
    char *atomNames[] = {
        const_cast<char *>("_NET_ACTIVE_WINDOW"),
        const_cast<char *>("_NET_WM_STATE"),
        const_cast<char *>("_NET_WM_STATE_FULLSCREEN"),
        const_cast<char *>("_NET_WM_PID"),
    };
    Atom atoms[4] = {};
    XInternAtoms(display, atomNames, 4, True, atoms);
    const Atom activeAtom = atoms[0];
    const Atom stateAtom = atoms[1];
    const Atom fullscreenAtom = atoms[2];
    const Atom pidAtom = atoms[3];
