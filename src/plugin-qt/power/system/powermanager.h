...
private:
    ...
    void setShortIdleState(bool state);
    bool writeStateFile(const QString &path, bool state);
    ...
    QString m_idleStatePath = QStringLiteral("/sys/devices/system/loongarch/relax_state");
    QString m_idleScreenStatePath = QStringLiteral("/sys/devices/system/loongarch/idle_state");
