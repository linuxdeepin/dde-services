...
bool utils::checkWallpaperLockedStatus()
{
    return QFileInfo::exists("/var/lib/deepin/permission-manager/wallpaper_locked");
}
bool utils::isSolidWallpaper(const QString &path)
{
    for (const auto &dir : SolidWallpaperDir) {
