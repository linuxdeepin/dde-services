...
def extract_translations(config_dir, output_file, app_id):
    """
    Scans the config_dir for org.deepin.shortcut.json files and extracts 
    the displayName field into a dummy C++ file for lupdate scanning.
    """
    display_names = set()
    
    for root, dirs, files in os.walk(config_dir):
        for file in files:
            if file == "org.deepin.shortcut.json":
