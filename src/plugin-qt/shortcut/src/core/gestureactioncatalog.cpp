...
const QList<GestureActionMetadata> &GestureActionCatalog::metadata()
{
    static const QList<GestureActionMetadata> catalog = {
        ...
        {GestureActionId::RestoreWindow, QT_TRANSLATE_NOOP("org.deepin.dde.keybinding", "Unmaximize window")},
        ...
        {GestureActionId::ToggleMultitask, QT_TRANSLATE_NOOP("org.deepin.dde.keybinding", "Show multitasking view")},
